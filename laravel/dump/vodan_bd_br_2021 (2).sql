 ...
 select crfformsid as modId, questionid as qstId, questionorder as qstOrder, qstgroupid as qstGroupId,
		...
		from (
			select crfformsid, questionid, questioncomment, questionorder, 
				   ...
				   Question,
				   QuestionType, QuestionTypeComment, listTypeResposta, listTypeID, IdQuestaoSubordinada_A, QuestaoSubordinada_A, QuestaoReferente_A
			from (
...
(242, 'Facility Name', 7, NULL, NULL, NULL, NULL, 'Este é um comentário sobre a questão'),
