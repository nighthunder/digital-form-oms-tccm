...
--
-- Host: 127.0.0.1
-- Tempo de geração: 03-Nov-2022 às 22:53
...
--
-- Banco de dados: `vodan_br_bd_2021`
--
...
#========================================================================================================================
 ...
 select crfformsid as modId, questionid as qstId, questionorder as qstOrder, qstgroupid as qstGroupId,
		  ...
		  translate('pt-br', question) as dsc_qst,
                ...
                (Select questionTypeID from tb_questions where questionID = tb_Questionario.questionID) as qst_type_id,
                (Select listTypeID from tb_questions where questionID = tb_Questionario.questionID) as qst_list_type_id,
...
sp:BEGIN		
   START TRANSACTION;
    ...
    set v_lista = concat(p_stringlisttype, ',') ;
    ...
    while length(v_lista) > 1 DO
        ...
        if v_questionid is not null then
			...
			INSERT into tb_listtype(listTypeID, description,`comment`) VALUES(v_questionid, v_answer, null);
  ...
  #      SELECT v_lista, length(v_lista), position(',' in v_lista);
    ...
    set p_msg_retorno = 'Novos tipos de lista inseridos com sucesso.';
...
#    set last_id = (Select MAX(crfFormsID) + 1 where tb_crfforms);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `postQstMultilanguage` (IN `p_language` INT, IN `p_stringquestions` TEXT, OUT `p_msg_retorno` VARCHAR(500))  BEGIN
#========================================================================================================================
#== Procedure criada para traduzir as descrições das questões
#== Criada em 01 maio 2021
#========================================================================================================================
   ...
   START TRANSACTION;
    ...
    while length(v_lista) > 1 DO
        ...
        if v_questionid is not null then
			...
			Insert into tb_multilanguage (languageID, description, descriptionLang) values(p_language,v_answer, v_answer);
   ...
   START TRANSACTION;
    ...
    while length(v_lista) > 1 DO
        ...
        if v_questionid is not null then
			...
			update tb_questiongroupform set questionOrder = CONVERT(v_answer,UNSIGNED) where questionID = v_questionid;
...
sp:BEGIN		
   START TRANSACTION;
	...
	# Inserindo/Alterando as questoes registro do form e a questão associada a data    
    set v_lista = concat(p_stringquestionstypes, ',') ;
    ...
    while length(v_lista) > 1 DO
        ...
        if v_questionid is not null then
			...
			UPDATE tb_questions set questionTypeID = CONVERT(v_answer, UNSIGNED) where questionID = v_questionid;
  ...
  #      SELECT v_lista, length(v_lista), position(',' in v_lista);
    ...
    set p_msg_retorno = 'Tipos atualizados das questões com sucesso.';
...
(12, 11, 'Admission Form', 2, '2022-10-31 20:46:26', '2022-10-31 20:46:26'),
(600, 11, 'Follow-up', 2, '2022-10-31 20:54:53', '2022-10-31 20:54:53');
...
(2, 'País', 'País'),
(1, 'Nome da Instalação', 'Nome da Instalação'),
(2, 'Nome da Instalação', 'Nome da Instalação'),
(1, 'Data de inscrição', 'Data de inscrição'),
(2, 'Data de inscrição', 'Data de inscrição'),
(1, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública'),
(2, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública'),
(1, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC'),
(2, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC'),
(1, 'Tosse', 'Tosse'),
(2, 'Tosse', 'Tosse'),
(1, 'Dispneia (falta de ar) ou Taquipneia', 'Dispneia (falta de ar) ou Taquipneia'),
(2, 'Dispneia (falta de ar) ou Taquipneia', 'Dispneia (falta de ar) ou Taquipneia'),
(1, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima'),
(2, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima'),
(1, 'Sexo ao Nascer', 'Sexo ao Nascer'),
(2, 'Sexo ao Nascer', 'Sexo ao Nascer'),
(1, 'Data de nascimento', 'Data de nascimento'),
(2, 'Data de nascimento', 'Data de nascimento'),
(1, 'Idade (meses)', 'Idade (meses)'),
(2, 'Idade (meses)', 'Idade (meses)'),
(1, 'Idade (anos)', 'Idade (anos)'),
(2, 'Idade (anos)', 'Idade (anos)'),
(1, 'Profissional de Saúde', 'Profissional de Saúde'),
(2, 'Profissional de Saúde', 'Profissional de Saúde'),
(1, 'Profissional de Laboratório', 'Profissional de Laboratório'),
(2, 'Profissional de Laboratório', 'Profissional de Laboratório');
...
(14, 'Vital signs', ''),
(234, 'testado', ''),
(235, 'Critérios Clínicos para Inclusão', ''),
(236, 'Dados demográficos', ''),
(237, 'Início da doença e sinais vitais na admissão', ''),
(238, 'Comorbidades', ''),
(239, 'Pré-admissão e medicamentos de uso contínuo', ''),
(240, 'Sinais e sintomas na hora da admissão', ''),
(241, 'Medicação', ''),
(242, 'Cuidados', ''),
(243, 'Resultados laboratoriais]', ''),
(244, 'Critérios Clínicos para Inclusão', ''),
(245, 'Dados demográficos', ''),
(246, 'Início da doença e sinais vitais na admissão', ''),
(247, 'Comorbidades', ''),
(248, 'Pré-admissão e medicamentos de uso contínuo', ''),
(249, 'Sinais e sintomas na hora da admissão', ''),
(250, 'Medicação', ''),
(251, 'Cuidados', ''),
(252, 'Resultados laboratoriais]', ''),
(253, 'Critérios Clínicos para Inclusão', ''),
(254, 'Dados demográficos', ''),
(255, 'Início da doença e sinais vitais na admissão', ''),
(256, 'Comorbidades', ''),
(257, 'Pré-admissão e medicamentos de uso contínuo', ''),
(258, 'Sinais e sintomas na hora da admissão', ''),
(259, 'Medicação', ''),
(260, 'Cuidados', ''),
(261, 'Resultados laboratoriais]', ''),
(262, 'Critérios Clínicos para Inclusão', ''),
(263, 'Dados demográficos', ''),
(264, 'Início da doença e sinais vitais na admissão', ''),
(265, 'Comorbidades', ''),
(266, 'Pré-admissão e medicamentos de uso contínuo', ''),
(267, 'Sinais e sintomas na hora da admissão', ''),
(268, 'Medicação', ''),
(269, 'Cuidados', ''),
(270, 'Resultados laboratoriais]', ''),
(271, 'Critérios Clínicos para Inclusão', ''),
(272, 'Dados demográficos', ''),
(273, 'Início da doença e sinais vitais na admissão', ''),
(274, 'Comorbidades', ''),
(275, 'Pré-admissão e medicamentos de uso contínuo', ''),
(276, 'Sinais e sintomas na hora da admissão', ''),
(277, 'Medicação', ''),
(278, 'Cuidados', ''),
(279, 'Resultados laboratoriais]', ''),
(280, 'Critérios Clínicos para Inclusão', ''),
(281, 'Dados demográficos', ''),
(282, 'Início da doença e sinais vitais na admissão', ''),
(283, 'Comorbidades', ''),
(284, 'Pré-admissão e medicamentos de uso contínuo', ''),
(285, 'Sinais e sintomas na hora da admissão', ''),
(286, 'Medicação', ''),
(287, 'Cuidados', ''),
(288, 'Resultados laboratoriais]', ''),
(289, 'Critérios Clínicos para Inclusão', ''),
(290, 'Dados demográficos', ''),
(291, 'Início da doença e sinais vitais na admissão', ''),
(292, 'Comorbidades', ''),
(293, 'Pré-admissão e medicamentos de uso contínuo', ''),
(294, 'Sinais e sintomas na hora da admissão', ''),
(295, 'Medicação', ''),
(296, 'Cuidados', ''),
(297, 'Resultados laboratoriais]', ''),
(298, 'Critérios Clínicos para Inclusão', ''),
(299, 'Dados demográficos', ''),
(300, 'Início da doença e sinais vitais na admissão', ''),
(301, 'Comorbidades', ''),
(302, 'Pré-admissão e medicamentos de uso contínuo', ''),
(303, 'Sinais e sintomas na hora da admissão', ''),
(304, 'Medicação', ''),
(305, 'Cuidados', ''),
(306, 'Resultados laboratoriais]', ''),
(307, 'Critérios Clínicos para Inclusão', ''),
(308, 'Dados demográficos', ''),
(309, 'Início da doença e sinais vitais na admissão', ''),
(310, 'Comorbidades', ''),
(311, 'Pré-admissão e medicamentos de uso contínuo', ''),
(312, 'Sinais e sintomas na hora da admissão', ''),
(313, 'Medicação', ''),
(314, 'Cuidados', ''),
(315, 'Resultados laboratoriais]', ''),
(316, 'Critérios Clínicos para Inclusão', ''),
(317, 'Dados demográficos', ''),
(318, 'Início da doença e sinais vitais na admissão', ''),
(319, 'Comorbidades', ''),
(320, 'Pré-admissão e medicamentos de uso contínuo', ''),
(321, 'Sinais e sintomas na hora da admissão', ''),
(322, 'Medicação', ''),
(323, 'Cuidados', ''),
(324, 'Resultados laboratoriais]', ''),
(325, 'Critérios Clínicos para Inclusão', ''),
(326, 'Dados demográficos', ''),
(327, 'Início da doença e sinais vitais na admissão', ''),
(328, 'Comorbidades', ''),
(329, 'Pré-admissão e medicamentos de uso contínuo', ''),
(330, 'Sinais e sintomas na hora da admissão', ''),
(331, 'Medicação', ''),
(332, 'Cuidados', ''),
(333, 'Resultados laboratoriais]', ''),
(334, 'Critérios Clínicos para Inclusão', ''),
(335, 'Dados demográficos', ''),
(336, 'Início da doença e sinais vitais na admissão', ''),
(337, 'Comorbidades', ''),
(338, 'Pré-admissão e medicamentos de uso contínuo', ''),
(339, 'Sinais e sintomas na hora da admissão', ''),
(340, 'Medicação', ''),
(341, 'Cuidados', ''),
(342, 'Resultados laboratoriais]', ''),
(343, 'Critérios Clínicos para Inclusão', ''),
(344, 'Dados demográficos', ''),
(345, 'Início da doença e sinais vitais na admissão', ''),
(346, 'Comorbidades', ''),
(347, 'Pré-admissão e medicamentos de uso contínuo', ''),
(348, 'Sinais e sintomas na hora da admissão', ''),
(349, 'Medicação', ''),
(350, 'Cuidados', ''),
(351, 'Resultados laboratoriais]', ''),
(352, 'Critérios Clínicos para Inclusão', ''),
(353, 'Dados demográficos', ''),
(354, 'Início da doença e sinais vitais na admissão', ''),
(355, 'Comorbidades', ''),
(356, 'Pré-admissão e medicamentos de uso contínuo', ''),
(357, 'Sinais e sintomas na hora da admissão', ''),
(358, 'Medicação', ''),
(359, 'Cuidados', ''),
(360, 'Resultados laboratoriais]', ''),
(361, 'Critérios Clínicos para Inclusão', ''),
(362, 'Dados demográficos', ''),
(363, 'Início da doença e sinais vitais na admissão', ''),
(364, 'Comorbidades', ''),
(365, 'Pré-admissão e medicamentos de uso contínuo', ''),
(366, 'Sinais e sintomas na hora da admissão', ''),
(367, 'Medicação', ''),
(368, 'Cuidados', ''),
(369, 'Resultados laboratoriais]', ''),
(370, 'Critérios Clínicos para Inclusão', ''),
(371, 'Dados demográficos', ''),
(372, 'Início da doença e sinais vitais na admissão', ''),
(373, 'Comorbidades', ''),
(374, 'Pré-admissão e medicamentos de uso contínuo', ''),
(375, 'Sinais e sintomas na hora da admissão', ''),
(376, 'Medicação', ''),
(377, 'Cuidados', ''),
(378, 'Resultados laboratoriais]', '');
...
(12, 'teste', 2, 1, 0, '0.0', '2022-11-01 07:02:22', '2022-11-01 07:02:22');
...
(159, 'IL-6', 3, NULL, 8, NULL, NULL, NULL, 'Este é um comentário sobre a questão'),
...
(257, 'País', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(258, 'Nome da Instalação', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(259, 'Data de inscrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(260, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(261, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(262, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(263, 'Dispneia (falta de ar) ou Taquipneia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(264, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(265, 'Sexo ao Nascer', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(266, 'Data de nascimento', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(267, 'Idade (meses)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(268, 'Idade (anos)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(269, 'Profissional de Saúde', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(270, 'Profissional de Laboratório', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(271, 'Grávida?', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(272, 'Tempo de gravidez', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(273, 'Início de Sintomas (data do primeiro sintoma)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(274, 'Data de admissão nesta unidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(275, 'Temperatura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(276, 'Frequência cardíaca', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(277, 'Frequência respiratória', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(278, 'Pressão arterial (sistólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(279, 'Pressão arterial (diastólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(280, 'Desidratação severa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(281, 'Tempo de enchimento capilar >2 segundos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(282, 'Saturação de oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(283, 'em', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(284, 'Escala A V D I', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(285, 'Escala de Coma de Glasgow (GCS /15)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(286, 'Desnutrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(287, 'Circunferência braquial', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(288, 'Altura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(289, 'Peso', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(290, 'Doença cardíaca crônica (não hipertensão)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(291, 'Hipertensão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(292, 'Doença pulmonar crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(293, 'Asma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(294, 'Doença renal crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(295, 'Doença hepática crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(296, 'Doença neurológica crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(297, 'HIV', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(298, 'Diabete', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(299, 'Fumante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1389, 'Leucócitos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1388, 'Hemoglobina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1387, 'Terapia de substituição renal ou diálise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1386, 'Suporte extracorpóreo (ECMO)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1385, 'Inotrópicos/vasopressores', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1384, 'Pressão parcial do O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1383, 'Pressão parcial do CO2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1382, 'Pressão do plato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1381, 'Fração de oxigênio inspirado', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1380, 'Pressão expiratória final positiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1379, 'Ventilação invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1378, 'Posição prona', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1377, 'Ventilação não-invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1376, 'Interface de oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1375, 'Fonte de Oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1374, 'Vazão de O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1373, 'Oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1372, 'UTI ou UCE', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1371, 'Anticoagulação sistêmica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1370, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1369, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1368, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1367, 'Qual agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1366, 'Agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1365, 'Qual agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1364, 'Agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1363, 'Agente antifungal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1362, 'Antibiótico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1361, 'Dose diária máxima de corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1360, 'Qual via do corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1359, 'Corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1358, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1356, 'Antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1357, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1355, 'Hidratação venosa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1354, 'Hidratação oral/orogástrica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1353, 'Qual sinal ou sintoma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1352, 'Outros', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1351, 'Localidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1350, 'Sangramento (hemorragia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1349, 'Incapaz de andar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1348, 'Linfadenopatia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1347, 'Úlceras cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1346, 'Erupções cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1345, 'Conjuntivite', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1344, 'Diarréia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1343, 'Vômito/náusea', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1342, 'Dor abdominal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1341, 'Convulsões', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1340, 'Consciência alterada/confusão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1339, 'Dor de cabeça', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1338, 'Retração toráxica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1337, 'Falta de ar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1336, 'Perda do Olfato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1335, 'Perda do paladar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1334, 'Fadiga/mal estar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1333, 'Dor articular (artralgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1332, 'Dor muscular (mialgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1331, 'Dor no peito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1330, 'Respiração sibilante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1329, 'Coriza (rinorréia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1328, 'Dor de garganta', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1326, 'Tosse com expectoração', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1327, 'Tosse com hemóptise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1325, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1324, 'Histórico de febre', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1323, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1322, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1321, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1320, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1319, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1318, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1317, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1316, 'Neoplasma maligno', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1315, 'Asplenia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1314, 'Tuberculose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1313, 'Fumante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1312, 'Diabete', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1311, 'HIV', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1309, 'Doença hepática crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1310, 'Doença neurológica crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1308, 'Doença renal crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1307, 'Asma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1305, 'Hipertensão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1306, 'Doença pulmonar crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1304, 'Doença cardíaca crônica (não hipertensão)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1303, 'Peso', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1302, 'Altura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1301, 'Circunferência braquial', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1300, 'Desnutrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1299, 'Escala de Coma de Glasgow (GCS /15)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1298, 'Escala A V D I', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1297, 'em', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1296, 'Saturação de oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1295, 'Tempo de enchimento capilar >2 segundos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1294, 'Desidratação severa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1293, 'Pressão arterial (diastólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1292, 'Pressão arterial (sistólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1291, 'Frequência respiratória', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1290, 'Frequência cardíaca', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1289, 'Temperatura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1288, 'Data de admissão nesta unidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1287, 'Início de Sintomas (data do primeiro sintoma)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1286, 'Tempo de gravidez', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1285, 'Grávida?', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1284, 'Profissional de Laboratório', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1283, 'Profissional de Saúde', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1282, 'Idade (anos)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1281, 'Idade (meses)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1280, 'Data de nascimento', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1279, 'Sexo ao Nascer', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1278, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1277, 'Dispneia (falta de ar) ou Taquipneia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1276, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1275, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1274, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1273, 'Data de inscrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1272, 'Nome da Instalação', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1271, 'País', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1270, 'IL-6]', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1269, 'Ferritina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1268, 'Dimero D', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1267, 'VHS', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1266, 'Troponina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1265, 'Creatina quinase', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1264, 'LDH', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1263, 'PCR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1262, 'Potássio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1261, 'Procalcitonina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1260, 'Sódio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1259, 'Creatinina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1258, 'Lactose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1257, 'Uréia (BUN)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1256, 'AST/TGO', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1255, 'Bilirrubina total', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1254, 'ALT/TGP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1253, 'INR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1252, 'TP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1251, 'TTPA/APTR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1250, 'Plaquetas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1249, 'Hematócrito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1248, 'Leucócitos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1247, 'Hemoglobina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1246, 'Terapia de substituição renal ou diálise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1245, 'Suporte extracorpóreo (ECMO)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1244, 'Inotrópicos/vasopressores', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1243, 'Pressão parcial do O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1241, 'Pressão do plato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1242, 'Pressão parcial do CO2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1240, 'Fração de oxigênio inspirado', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1239, 'Pressão expiratória final positiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1238, 'Ventilação invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1237, 'Posição prona', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1236, 'Ventilação não-invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1235, 'Interface de oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1234, 'Fonte de Oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1233, 'Vazão de O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1232, 'Oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1231, 'UTI ou UCE', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1230, 'Anticoagulação sistêmica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1229, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1228, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1227, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1226, 'Qual agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1225, 'Agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1224, 'Qual agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1223, 'Agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1222, 'Agente antifungal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1221, 'Antibiótico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1220, 'Dose diária máxima de corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1219, 'Qual via do corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1218, 'Corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1216, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1217, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1215, 'Antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1214, 'Hidratação venosa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1212, 'Qual sinal ou sintoma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1213, 'Hidratação oral/orogástrica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1211, 'Outros', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1210, 'Localidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1209, 'Sangramento (hemorragia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1208, 'Incapaz de andar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1207, 'Linfadenopatia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1206, 'Úlceras cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1205, 'Erupções cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1204, 'Conjuntivite', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1203, 'Diarréia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1202, 'Vômito/náusea', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1201, 'Dor abdominal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1200, 'Convulsões', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1199, 'Consciência alterada/confusão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1198, 'Dor de cabeça', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1197, 'Retração toráxica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1196, 'Falta de ar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1195, 'Perda do Olfato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1194, 'Perda do paladar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1193, 'Fadiga/mal estar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1192, 'Dor articular (artralgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1191, 'Dor muscular (mialgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1190, 'Dor no peito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1189, 'Respiração sibilante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1188, 'Coriza (rinorréia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1187, 'Dor de garganta', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1186, 'Tosse com hemóptise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1185, 'Tosse com expectoração', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1184, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1182, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1183, 'Histórico de febre', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1181, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1180, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1179, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1178, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1177, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1176, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1175, 'Neoplasma maligno', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1174, 'Asplenia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1173, 'Tuberculose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1172, 'Fumante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1171, 'Diabete', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1170, 'HIV', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1169, 'Doença neurológica crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1168, 'Doença hepática crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1167, 'Doença renal crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1166, 'Asma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1165, 'Doença pulmonar crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1164, 'Hipertensão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1163, 'Doença cardíaca crônica (não hipertensão)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1162, 'Peso', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1161, 'Altura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1160, 'Circunferência braquial', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1159, 'Desnutrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1158, 'Escala de Coma de Glasgow (GCS /15)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1157, 'Escala A V D I', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1156, 'em', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1155, 'Saturação de oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1154, 'Tempo de enchimento capilar >2 segundos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1153, 'Desidratação severa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1152, 'Pressão arterial (diastólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1151, 'Pressão arterial (sistólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1149, 'Frequência cardíaca', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1150, 'Frequência respiratória', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1148, 'Temperatura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1147, 'Data de admissão nesta unidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1146, 'Início de Sintomas (data do primeiro sintoma)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1145, 'Tempo de gravidez', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1144, 'Grávida?', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1143, 'Profissional de Laboratório', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1142, 'Profissional de Saúde', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1141, 'Idade (anos)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1140, 'Idade (meses)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1139, 'Data de nascimento', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1138, 'Sexo ao Nascer', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1137, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1136, 'Dispneia (falta de ar) ou Taquipneia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1135, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1134, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1133, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1132, 'Data de inscrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1131, 'Nome da Instalação', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1130, 'País', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(581, 'IL-6]', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(580, 'Ferritina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(579, 'Dimero D', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(578, 'VHS', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(577, 'Troponina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(574, 'PCR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(575, 'LDH', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(576, 'Creatina quinase', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(573, 'Potássio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(572, 'Procalcitonina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(571, 'Sódio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(569, 'Lactose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(570, 'Creatinina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(568, 'Uréia (BUN)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(567, 'AST/TGO', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(566, 'Bilirrubina total', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(565, 'ALT/TGP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(564, 'INR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(563, 'TP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(562, 'TTPA/APTR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(561, 'Plaquetas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(560, 'Hematócrito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(559, 'Leucócitos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(558, 'Hemoglobina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(557, 'Terapia de substituição renal ou diálise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(556, 'Suporte extracorpóreo (ECMO)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(555, 'Inotrópicos/vasopressores', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(554, 'Pressão parcial do O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(553, 'Pressão parcial do CO2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(552, 'Pressão do plato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(551, 'Fração de oxigênio inspirado', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(550, 'Pressão expiratória final positiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(549, 'Ventilação invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(548, 'Posição prona', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(547, 'Ventilação não-invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(546, 'Interface de oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(545, 'Fonte de Oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(544, 'Vazão de O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(542, 'UTI ou UCE', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(543, 'Oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(541, 'Anticoagulação sistêmica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(540, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(539, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(538, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(537, 'Qual agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(536, 'Agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(535, 'Qual agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(534, 'Agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(533, 'Agente antifungal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(532, 'Antibiótico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(531, 'Dose diária máxima de corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(530, 'Qual via do corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(529, 'Corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(528, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(527, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(526, 'Antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(525, 'Hidratação venosa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(524, 'Hidratação oral/orogástrica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(523, 'Qual sinal ou sintoma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(522, 'Outros', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(521, 'Localidade', 7, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tb_questions` (`questionID`, `description`, `questionTypeID`, `listTypeID`, `questionGroupID`, `subordinateTo`, `subordinateValues`, `isAbout`, `comment`) VALUES
(520, 'Sangramento (hemorragia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(519, 'Incapaz de andar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(518, 'Linfadenopatia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(517, 'Úlceras cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(516, 'Erupções cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(515, 'Conjuntivite', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(514, 'Diarréia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(513, 'Vômito/náusea', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(512, 'Dor abdominal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(511, 'Convulsões', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(510, 'Consciência alterada/confusão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(508, 'Retração toráxica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(509, 'Dor de cabeça', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(507, 'Falta de ar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(506, 'Perda do Olfato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(505, 'Perda do paladar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(504, 'Fadiga/mal estar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(503, 'Dor articular (artralgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(502, 'Dor muscular (mialgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(501, 'Dor no peito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(500, 'Respiração sibilante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(499, 'Coriza (rinorréia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(498, 'Dor de garganta', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(497, 'Tosse com hemóptise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(496, 'Tosse com expectoração', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(495, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(494, 'Histórico de febre', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(493, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(492, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(491, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(490, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(489, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(488, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(487, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(486, 'Neoplasma maligno', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(485, 'Asplenia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(484, 'Tuberculose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(483, 'Fumante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(482, 'Diabete', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(481, 'HIV', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(480, 'Doença neurológica crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(479, 'Doença hepática crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(478, 'Doença renal crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(477, 'Asma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(476, 'Doença pulmonar crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(475, 'Hipertensão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(474, 'Doença cardíaca crônica (não hipertensão)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(473, 'Peso', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(472, 'Altura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(471, 'Circunferência braquial', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(470, 'Desnutrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(469, 'Escala de Coma de Glasgow (GCS /15)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(468, 'Escala A V D I', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(467, 'em', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(466, 'Saturação de oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(465, 'Tempo de enchimento capilar >2 segundos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(464, 'Desidratação severa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(463, 'Pressão arterial (diastólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(462, 'Pressão arterial (sistólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(461, 'Frequência respiratória', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(460, 'Frequência cardíaca', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(459, 'Temperatura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(458, 'Data de admissão nesta unidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(457, 'Início de Sintomas (data do primeiro sintoma)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(456, 'Tempo de gravidez', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(455, 'Grávida?', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(454, 'Profissional de Laboratório', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(453, 'Profissional de Saúde', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(451, 'Idade (meses)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(452, 'Idade (anos)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(450, 'Data de nascimento', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(449, 'Sexo ao Nascer', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(448, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(447, 'Dispneia (falta de ar) ou Taquipneia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(446, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(445, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(444, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(443, 'Data de inscrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(442, 'Nome da Instalação', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(440, 'IL-6]', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(439, 'Ferritina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(438, 'Dimero D', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(437, 'VHS', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(436, 'Troponina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(435, 'Creatina quinase', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(434, 'LDH', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(433, 'PCR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(432, 'Potássio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(431, 'Procalcitonina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(430, 'Sódio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(429, 'Creatinina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(428, 'Lactose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(427, 'Uréia (BUN)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(426, 'AST/TGO', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(425, 'Bilirrubina total', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(424, 'ALT/TGP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(423, 'INR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(422, 'TP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(421, 'TTPA/APTR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(420, 'Plaquetas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(419, 'Hematócrito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(418, 'Leucócitos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(417, 'Hemoglobina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(416, 'Terapia de substituição renal ou diálise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(414, 'Inotrópicos/vasopressores', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(415, 'Suporte extracorpóreo (ECMO)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(413, 'Pressão parcial do O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(412, 'Pressão parcial do CO2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(411, 'Pressão do plato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(410, 'Fração de oxigênio inspirado', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(409, 'Pressão expiratória final positiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(408, 'Ventilação invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(407, 'Posição prona', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(406, 'Ventilação não-invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(405, 'Interface de oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(404, 'Fonte de Oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(403, 'Vazão de O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(402, 'Oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(401, 'UTI ou UCE', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(400, 'Anticoagulação sistêmica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(399, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(398, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(397, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(396, 'Qual agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(395, 'Agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(394, 'Qual agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(393, 'Agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(392, 'Agente antifungal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(391, 'Antibiótico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(390, 'Dose diária máxima de corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(389, 'Qual via do corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(388, 'Corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(386, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(387, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(385, 'Antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(384, 'Hidratação venosa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(383, 'Hidratação oral/orogástrica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(382, 'Qual sinal ou sintoma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(381, 'Outros', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(380, 'Localidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(379, 'Sangramento (hemorragia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(378, 'Incapaz de andar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(377, 'Linfadenopatia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(376, 'Úlceras cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(375, 'Erupções cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(374, 'Conjuntivite', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(373, 'Diarréia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(372, 'Vômito/náusea', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(371, 'Dor abdominal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(370, 'Convulsões', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(369, 'Consciência alterada/confusão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(368, 'Dor de cabeça', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(367, 'Retração toráxica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(366, 'Falta de ar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(365, 'Perda do Olfato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(364, 'Perda do paladar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(363, 'Fadiga/mal estar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(362, 'Dor articular (artralgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(361, 'Dor muscular (mialgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(360, 'Dor no peito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(359, 'Respiração sibilante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(358, 'Coriza (rinorréia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(357, 'Dor de garganta', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(356, 'Tosse com hemóptise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(354, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(355, 'Tosse com expectoração', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(353, 'Histórico de febre', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(352, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(351, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(350, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(349, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(348, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(347, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(346, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(345, 'Neoplasma maligno', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(344, 'Asplenia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(343, 'Tuberculose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(342, 'Fumante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(341, 'Diabete', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(340, 'HIV', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(339, 'Doença neurológica crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(338, 'Doença hepática crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(337, 'Doença renal crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(336, 'Asma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(335, 'Doença pulmonar crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(334, 'Hipertensão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(333, 'Doença cardíaca crônica (não hipertensão)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(332, 'Peso', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(331, 'Altura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(330, 'Circunferência braquial', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(329, 'Desnutrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(328, 'Escala de Coma de Glasgow (GCS /15)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(327, 'Escala A V D I', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(326, 'em', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(325, 'Saturação de oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(324, 'Tempo de enchimento capilar >2 segundos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(323, 'Desidratação severa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(322, 'Pressão arterial (diastólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(321, 'Pressão arterial (sistólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(320, 'Frequência respiratória', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(319, 'Frequência cardíaca', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(318, 'Temperatura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(317, 'Data de admissão nesta unidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(316, 'Início de Sintomas (data do primeiro sintoma)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(315, 'Tempo de gravidez', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(314, 'Grávida?', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(313, 'Profissional de Laboratório', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(312, 'Profissional de Saúde', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(311, 'Idade (anos)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(310, 'Idade (meses)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(309, 'Data de nascimento', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(308, 'Sexo ao Nascer', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(307, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(306, 'Dispneia (falta de ar) ou Taquipneia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(305, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(304, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(303, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(302, 'Data de inscrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(301, 'Nome da Instalação', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1129, 'País', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1390, 'Hematócrito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1391, 'Plaquetas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1392, 'TTPA/APTR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1393, 'TP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1394, 'INR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1395, 'ALT/TGP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1396, 'Bilirrubina total', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1397, 'AST/TGO', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1398, 'Uréia (BUN)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1399, 'Lactose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1400, 'Creatinina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1401, 'Sódio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1402, 'Procalcitonina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1403, 'Potássio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1404, 'PCR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1405, 'LDH', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1406, 'Creatina quinase', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1407, 'Troponina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1408, 'VHS', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1409, 'Dimero D', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1410, 'Ferritina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1411, 'IL-6]', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1412, 'País', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1413, 'Nome da Instalação', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1414, 'Data de inscrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1415, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1416, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1417, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1418, 'Dispneia (falta de ar) ou Taquipneia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1419, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1420, 'Sexo ao Nascer', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1421, 'Data de nascimento', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1422, 'Idade (meses)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1423, 'Idade (anos)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1424, 'Profissional de Saúde', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1425, 'Profissional de Laboratório', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1426, 'Grávida?', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1427, 'Tempo de gravidez', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1428, 'Início de Sintomas (data do primeiro sintoma)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1429, 'Data de admissão nesta unidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1430, 'Temperatura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1431, 'Frequência cardíaca', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1432, 'Frequência respiratória', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1433, 'Pressão arterial (sistólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1434, 'Pressão arterial (diastólica)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1435, 'Desidratação severa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1436, 'Tempo de enchimento capilar >2 segundos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1437, 'Saturação de oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1438, 'em', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1439, 'Escala A V D I', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1440, 'Escala de Coma de Glasgow (GCS /15)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1441, 'Desnutrição', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1442, 'Circunferência braquial', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1443, 'Altura', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1444, 'Peso', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1445, 'Doença cardíaca crônica (não hipertensão)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1446, 'Hipertensão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1447, 'Doença pulmonar crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1448, 'Asma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1449, 'Doença renal crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1450, 'Doença hepática crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1451, 'Doença neurológica crônica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1452, 'HIV', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1453, 'Diabete', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1454, 'Fumante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1455, 'Tuberculose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1456, 'Asplenia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1457, 'Neoplasma maligno', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1458, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1459, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1460, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1461, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1462, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1463, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1464, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1465, 'Histórico de febre', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1466, 'Tosse', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1467, 'Tosse com expectoração', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1468, 'Tosse com hemóptise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1469, 'Dor de garganta', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1470, 'Coriza (rinorréia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1471, 'Respiração sibilante', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1472, 'Dor no peito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1473, 'Dor muscular (mialgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1474, 'Dor articular (artralgia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1475, 'Fadiga/mal estar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1476, 'Perda do paladar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1477, 'Perda do Olfato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1478, 'Falta de ar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1479, 'Retração toráxica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1480, 'Dor de cabeça', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1481, 'Consciência alterada/confusão', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1482, 'Convulsões', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1483, 'Dor abdominal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1484, 'Vômito/náusea', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1485, 'Diarréia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1486, 'Conjuntivite', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1487, 'Erupções cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1488, 'Úlceras cutâneas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1489, 'Linfadenopatia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1490, 'Incapaz de andar', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1491, 'Sangramento (hemorragia)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1492, 'Localidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1493, 'Outros', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1494, 'Qual sinal ou sintoma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1495, 'Hidratação oral/orogástrica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1496, 'Hidratação venosa', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1497, 'Antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1498, 'Qual antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1499, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1500, 'Corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1501, 'Qual via do corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1502, 'Dose diária máxima de corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1503, 'Antibiótico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1504, 'Agente antifungal', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1505, 'Agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1506, 'Qual agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1507, 'Agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1508, 'Qual agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1509, 'Antiinflamatório não esteroide (AINE)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1510, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1511, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1512, 'Anticoagulação sistêmica', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1513, 'UTI ou UCE', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1514, 'Oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1515, 'Vazão de O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1516, 'Fonte de Oxigênio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1517, 'Interface de oxigenoterapia', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1518, 'Ventilação não-invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1519, 'Posição prona', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1520, 'Ventilação invasiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1521, 'Pressão expiratória final positiva', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1522, 'Fração de oxigênio inspirado', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1523, 'Pressão do plato', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1524, 'Pressão parcial do CO2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1525, 'Pressão parcial do O2', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1526, 'Inotrópicos/vasopressores', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1527, 'Suporte extracorpóreo (ECMO)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1528, 'Terapia de substituição renal ou diálise', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1529, 'Hemoglobina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1530, 'Leucócitos', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1531, 'Hematócrito', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1532, 'Plaquetas', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1533, 'TTPA/APTR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1534, 'TP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1535, 'INR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1536, 'ALT/TGP', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1537, 'Bilirrubina total', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1538, 'AST/TGO', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1539, 'Uréia (BUN)', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1540, 'Lactose', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1541, 'Creatinina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1542, 'Sódio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1543, 'Procalcitonina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1544, 'Potássio', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1545, 'PCR', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1546, 'LDH', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1547, 'Creatina quinase', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1548, 'Troponina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1549, 'VHS', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1550, 'Dimero D', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1551, 'Ferritina', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1552, 'IL-6]', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1553, 'País', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1554, 'Nome da Instalação', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1555, 'Data de inscrição', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1556, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1557, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1558, 'Tosse', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1559, 'Dispneia (falta de ar) ou Taquipneia', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1560, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1561, 'Sexo ao Nascer', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1562, 'Data de nascimento', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1563, 'Idade (meses)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1564, 'Idade (anos)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1565, 'Profissional de Saúde', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1566, 'Profissional de Laboratório', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1567, 'Grávida?', 9, NULL, NULL, NULL, NULL, NULL, NULL),
(1568, 'Tempo de gravidez', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1569, 'Início de Sintomas (data do primeiro sintoma)', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1570, 'Data de admissão nesta unidade', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1571, 'Temperatura', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1572, 'Frequência cardíaca', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1573, 'Frequência respiratória', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1574, 'Pressão arterial (sistólica)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1575, 'Pressão arterial (diastólica)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1576, 'Desidratação severa', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1577, 'Tempo de enchimento capilar >2 segundos', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1578, 'Saturação de oxigênio', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1579, 'em', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1580, 'Escala A V D I', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1581, 'Escala de Coma de Glasgow (GCS /15)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1582, 'Desnutrição', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1583, 'Circunferência braquial', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1584, 'Altura', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1585, 'Peso', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1586, 'Doença cardíaca crônica (não hipertensão)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1587, 'Hipertensão', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1588, 'Doença pulmonar crônica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1589, 'Asma', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1590, 'Doença renal crônica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1591, 'Doença hepática crônica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1592, 'Doença neurológica crônica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1593, 'HIV', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1594, 'Diabete', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1595, 'Fumante', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1596, 'Tuberculose', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1597, 'Asplenia', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1598, 'Neoplasma maligno', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1599, 'Outras comorbidades', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1600, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1601, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1602, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1603, 'Antiinflamatório não esteroide (AINE)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1604, 'Qual antiviral', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1605, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1606, 'Histórico de febre', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1607, 'Tosse', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1608, 'Tosse com expectoração', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1609, 'Tosse com hemóptise', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1610, 'Dor de garganta', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1611, 'Coriza (rinorréia)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1612, 'Respiração sibilante', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1613, 'Dor no peito', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1614, 'Dor muscular (mialgia)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1615, 'Dor articular (artralgia)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1616, 'Fadiga/mal estar', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1617, 'Perda do paladar', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1618, 'Perda do Olfato', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1619, 'Falta de ar', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1620, 'Retração toráxica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1621, 'Dor de cabeça', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1622, 'Consciência alterada/confusão', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1623, 'Convulsões', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1624, 'Dor abdominal', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1625, 'Vômito/náusea', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1626, 'Diarréia', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1627, 'Conjuntivite', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1628, 'Erupções cutâneas', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1629, 'Úlceras cutâneas', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1630, 'Linfadenopatia', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1631, 'Incapaz de andar', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1632, 'Sangramento (hemorragia)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1633, 'Localidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1634, 'Outros', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1635, 'Qual sinal ou sintoma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1636, 'Hidratação oral/orogástrica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1637, 'Hidratação venosa', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1638, 'Antiviral', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1639, 'Qual antiviral', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1640, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1641, 'Corticosteroide', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1642, 'Qual via do corticosteroide', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1643, 'Dose diária máxima de corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1644, 'Antibiótico', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1645, 'Agente antifungal', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1646, 'Agente antimalárico', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1647, 'Qual agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1648, 'Agente experimental', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1649, 'Qual agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1650, 'Antiinflamatório não esteroide (AINE)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1651, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1652, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1653, 'Anticoagulação sistêmica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1654, 'UTI ou UCE', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1655, 'Oxigenoterapia', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1656, 'Vazão de O2', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1657, 'Fonte de Oxigênio', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1658, 'Interface de oxigenoterapia', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1659, 'Ventilação não-invasiva', 9, NULL, NULL, NULL, NULL, NULL, NULL),
(1660, 'Posição prona', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1661, 'Ventilação invasiva', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1662, 'Pressão expiratória final positiva', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1663, 'Fração de oxigênio inspirado', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1664, 'Pressão do plato', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1665, 'Pressão parcial do CO2', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1666, 'Pressão parcial do O2', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1667, 'Inotrópicos/vasopressores', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1668, 'Suporte extracorpóreo (ECMO)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1669, 'Terapia de substituição renal ou diálise', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1670, 'Hemoglobina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1671, 'Leucócitos', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1672, 'Hematócrito', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1673, 'Plaquetas', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1674, 'TTPA/APTR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1675, 'TP', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1676, 'INR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1677, 'ALT/TGP', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1678, 'Bilirrubina total', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1679, 'AST/TGO', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1680, 'Uréia (BUN)', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1681, 'Lactose', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1682, 'Creatinina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1683, 'Sódio', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1684, 'Procalcitonina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1685, 'Potássio', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1686, 'PCR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1687, 'LDH', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1688, 'Creatina quinase', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1689, 'Troponina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1690, 'VHS', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1691, 'Dimero D', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1692, 'Ferritina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1693, 'IL-6]', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1694, 'País', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1695, 'Nome da Instalação', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1696, 'Data de inscrição', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1697, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1698, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1699, 'Tosse', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1700, 'Dispneia (falta de ar) ou Taquipneia', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1701, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1702, 'Sexo ao Nascer', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1703, 'Data de nascimento', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1704, 'Idade (meses)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1705, 'Idade (anos)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1706, 'Profissional de Saúde', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1707, 'Profissional de Laboratório', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1708, 'Grávida?', 9, NULL, NULL, NULL, NULL, NULL, NULL),
(1709, 'Tempo de gravidez', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1710, 'Início de Sintomas (data do primeiro sintoma)', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1711, 'Data de admissão nesta unidade', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1712, 'Temperatura', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1713, 'Frequência cardíaca', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1714, 'Frequência respiratória', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1715, 'Pressão arterial (sistólica)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1716, 'Pressão arterial (diastólica)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1717, 'Desidratação severa', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1718, 'Tempo de enchimento capilar >2 segundos', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1719, 'Saturação de oxigênio', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1720, 'em', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1721, 'Escala A V D I', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1722, 'Escala de Coma de Glasgow (GCS /15)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1723, 'Desnutrição', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1724, 'Circunferência braquial', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1725, 'Altura', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1726, 'Peso', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1727, 'Doença cardíaca crônica (não hipertensão)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1728, 'Hipertensão', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1729, 'Doença pulmonar crônica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1730, 'Asma', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1731, 'Doença renal crônica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1732, 'Doença hepática crônica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1733, 'Doença neurológica crônica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1734, 'HIV', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1735, 'Diabete', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1736, 'Fumante', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1737, 'Tuberculose', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1738, 'Asplenia', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1739, 'Neoplasma maligno', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1740, 'Outras comorbidades', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1741, 'Outras comorbidades', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1742, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1743, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1744, 'Antiinflamatório não esteroide (AINE)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1745, 'Qual antiviral', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1746, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1747, 'Histórico de febre', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1748, 'Tosse', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1749, 'Tosse com expectoração', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1750, 'Tosse com hemóptise', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1751, 'Dor de garganta', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1752, 'Coriza (rinorréia)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1753, 'Respiração sibilante', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1754, 'Dor no peito', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1755, 'Dor muscular (mialgia)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1756, 'Dor articular (artralgia)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1757, 'Fadiga/mal estar', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1758, 'Perda do paladar', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1759, 'Perda do Olfato', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1760, 'Falta de ar', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1761, 'Retração toráxica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1762, 'Dor de cabeça', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1763, 'Consciência alterada/confusão', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1764, 'Convulsões', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1765, 'Dor abdominal', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1766, 'Vômito/náusea', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1767, 'Diarréia', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1768, 'Conjuntivite', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1769, 'Erupções cutâneas', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1770, 'Úlceras cutâneas', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1771, 'Linfadenopatia', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1772, 'Incapaz de andar', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1773, 'Sangramento (hemorragia)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1774, 'Localidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1775, 'Outros', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1776, 'Qual sinal ou sintoma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1777, 'Hidratação oral/orogástrica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1778, 'Hidratação venosa', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1779, 'Antiviral', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1780, 'Qual antiviral', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1781, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1782, 'Corticosteroide', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1783, 'Qual via do corticosteroide', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1784, 'Dose diária máxima de corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1785, 'Antibiótico', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1786, 'Agente antifungal', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1787, 'Agente antimalárico', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1788, 'Qual agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1789, 'Agente experimental', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1790, 'Qual agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1791, 'Antiinflamatório não esteroide (AINE)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1792, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1793, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1794, 'Anticoagulação sistêmica', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1795, 'UTI ou UCE', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1796, 'Oxigenoterapia', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1797, 'Vazão de O2', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1798, 'Fonte de Oxigênio', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1799, 'Interface de oxigenoterapia', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1800, 'Ventilação não-invasiva', 9, NULL, NULL, NULL, NULL, NULL, NULL),
(1801, 'Posição prona', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1802, 'Ventilação invasiva', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1803, 'Pressão expiratória final positiva', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1804, 'Fração de oxigênio inspirado', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1805, 'Pressão do plato', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1806, 'Pressão parcial do CO2', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1807, 'Pressão parcial do O2', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1808, 'Inotrópicos/vasopressores', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1809, 'Suporte extracorpóreo (ECMO)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1810, 'Terapia de substituição renal ou diálise', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1811, 'Hemoglobina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1812, 'Leucócitos', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1813, 'Hematócrito', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1814, 'Plaquetas', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1815, 'TTPA/APTR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1816, 'TP', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1817, 'INR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1818, 'ALT/TGP', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1819, 'Bilirrubina total', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1820, 'AST/TGO', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1821, 'Uréia (BUN)', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1822, 'Lactose', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1823, 'Creatinina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1824, 'Sódio', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1825, 'Procalcitonina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1826, 'Potássio', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1827, 'PCR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1828, 'LDH', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1829, 'Creatina quinase', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1830, 'Troponina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1831, 'VHS', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1832, 'Dimero D', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1833, 'Ferritina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1834, 'IL-6]', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1835, 'País', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1836, 'Nome da Instalação', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1837, 'Data de inscrição', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1838, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1839, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1840, 'Tosse', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1841, 'Dispneia (falta de ar) ou Taquipneia', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1842, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', 1, NULL, NULL, NULL, NULL, NULL, NULL),
(1843, 'Sexo ao Nascer', 4, 13, NULL, NULL, NULL, NULL, NULL),
(1844, 'Data de nascimento', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1845, 'Idade (meses)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1846, 'Idade (anos)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1847, 'Profissional de Saúde', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1848, 'Profissional de Laboratório', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1849, 'Grávida?', 9, NULL, NULL, NULL, NULL, NULL, NULL),
(1850, 'Tempo de gravidez', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1851, 'Início de Sintomas (data do primeiro sintoma)', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1852, 'Data de admissão nesta unidade', 2, NULL, NULL, NULL, NULL, NULL, NULL),
(1853, 'Temperatura', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1854, 'Frequência cardíaca', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1855, 'Frequência respiratória', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1856, 'Pressão arterial (sistólica)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1857, 'Pressão arterial (diastólica)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1858, 'Desidratação severa', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1859, 'Tempo de enchimento capilar >2 segundos', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1860, 'Saturação de oxigênio', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1861, 'em', 4, 10, NULL, NULL, NULL, NULL, NULL),
(1862, 'Escala A V D I', 4, 2, NULL, NULL, NULL, NULL, NULL),
(1863, 'Escala de Coma de Glasgow (GCS /15)', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1864, 'Desnutrição', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1865, 'Circunferência braquial', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1866, 'Altura', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1867, 'Peso', 5, NULL, NULL, NULL, NULL, NULL, NULL),
(1868, 'Doença cardíaca crônica (não hipertensão)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1869, 'Hipertensão', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1870, 'Doença pulmonar crônica', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1871, 'Asma', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1872, 'Doença renal crônica', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1873, 'Doença hepática crônica', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1874, 'Doença neurológica crônica', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1875, 'HIV', 4, 6, NULL, NULL, NULL, NULL, NULL),
(1876, 'Diabete', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1877, 'Fumante', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1878, 'Tuberculose', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1879, 'Asplenia', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1880, 'Neoplasma maligno', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1881, 'Outras comorbidades', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1882, 'Outras comorbidades', 7, 15, NULL, NULL, NULL, NULL, NULL),
(1883, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1884, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1885, 'Antiinflamatório não esteroide (AINE)', 8, NULL, NULL, NULL, NULL, NULL, NULL),
(1886, 'Qual antiviral', 4, NULL, NULL, NULL, NULL, NULL, NULL),
(1887, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1888, 'Histórico de febre', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1889, 'Tosse', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1890, 'Tosse com expectoração', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1891, 'Tosse com hemóptise', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1892, 'Dor de garganta', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1893, 'Coriza (rinorréia)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1894, 'Respiração sibilante', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1895, 'Dor no peito', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1896, 'Dor muscular (mialgia)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1897, 'Dor articular (artralgia)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1898, 'Fadiga/mal estar', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1899, 'Perda do paladar', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1900, 'Perda do Olfato', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1901, 'Falta de ar', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1902, 'Retração toráxica', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1903, 'Dor de cabeça', 8, 15, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `tb_questions` (`questionID`, `description`, `questionTypeID`, `listTypeID`, `questionGroupID`, `subordinateTo`, `subordinateValues`, `isAbout`, `comment`) VALUES
(1904, 'Consciência alterada/confusão', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1905, 'Convulsões', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1906, 'Dor abdominal', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1907, 'Vômito/náusea', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1908, 'Diarréia', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1909, 'Conjuntivite', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1910, 'Erupções cutâneas', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1911, 'Úlceras cutâneas', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1912, 'Linfadenopatia', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1913, 'Incapaz de andar', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1914, 'Sangramento (hemorragia)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1915, 'Localidade', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1916, 'Outros', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1917, 'Qual sinal ou sintoma', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1918, 'Hidratação oral/orogástrica', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1919, 'Hidratação venosa', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1920, 'Antiviral', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1921, 'Qual antiviral', 4, 1, NULL, NULL, NULL, NULL, NULL),
(1922, 'Qual outro antiviral', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1923, 'Corticosteroide', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1924, 'Qual via do corticosteroide', 4, 4, NULL, NULL, NULL, NULL, NULL),
(1925, 'Dose diária máxima de corticosteroide', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1926, 'Antibiótico', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1927, 'Agente antifungal', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1928, 'Agente antimalárico', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1929, 'Qual agente antimalárico', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1930, 'Agente experimental', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1931, 'Qual agente experimental', 7, NULL, NULL, NULL, NULL, NULL, NULL),
(1932, 'Antiinflamatório não esteroide (AINE)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1933, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1934, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1935, 'Anticoagulação sistêmica', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1936, 'UTI ou UCE', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1937, 'Oxigenoterapia', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1938, 'Vazão de O2', 4, 8, NULL, NULL, NULL, NULL, NULL),
(1939, 'Fonte de Oxigênio', 4, 14, NULL, NULL, NULL, NULL, NULL),
(1940, 'Interface de oxigenoterapia', 4, 7, NULL, NULL, NULL, NULL, NULL),
(1941, 'Ventilação não-invasiva', 9, NULL, NULL, NULL, NULL, NULL, NULL),
(1942, 'Posição prona', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1943, 'Ventilação invasiva', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1944, 'Pressão expiratória final positiva', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1945, 'Fração de oxigênio inspirado', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1946, 'Pressão do plato', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1947, 'Pressão parcial do CO2', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1948, 'Pressão parcial do O2', 10, NULL, NULL, NULL, NULL, NULL, NULL),
(1949, 'Inotrópicos/vasopressores', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1950, 'Suporte extracorpóreo (ECMO)', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1951, 'Terapia de substituição renal ou diálise', 8, 15, NULL, NULL, NULL, NULL, NULL),
(1952, 'Hemoglobina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1953, 'Leucócitos', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1954, 'Hematócrito', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1955, 'Plaquetas', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1956, 'TTPA/APTR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1957, 'TP', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1958, 'INR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1959, 'ALT/TGP', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1960, 'Bilirrubina total', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1961, 'AST/TGO', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1962, 'Uréia (BUN)', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1963, 'Lactose', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1964, 'Creatinina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1965, 'Sódio', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1966, 'Procalcitonina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1967, 'Potássio', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1968, 'PCR', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1969, 'LDH', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1970, 'Creatina quinase', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1971, 'Troponina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1972, 'VHS', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1973, 'Dimero D', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1974, 'Ferritina', 3, NULL, NULL, NULL, NULL, NULL, NULL),
(1975, 'IL-6]', 3, NULL, NULL, NULL, NULL, NULL, NULL);
...
ALTER TABLE `tb_multilanguage`
  ADD UNIQUE KEY `unique_index` (`languageID`,`description`);
...
--
ALTER TABLE `tb_crfforms`
  MODIFY `crfFormsID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=606;
...
--
ALTER TABLE `tb_listtype`
  MODIFY `listTypeID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `tb_questiongroup`
  MODIFY `questionGroupID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=379;

--
-- AUTO_INCREMENT de tabela `tb_questionnaire`
--
ALTER TABLE `tb_questionnaire`
  MODIFY `questionnaireID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tb_questions`
  MODIFY `questionID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1976;
