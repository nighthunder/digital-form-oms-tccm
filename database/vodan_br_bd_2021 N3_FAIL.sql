...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Nov-2022 às 04:04
...
sp:BEGIN		
	...
	SET v_nextid = (SELECT MAX(crfFormsID) FROM tb_crfforms);
   ...
   START TRANSACTION;
    ...
    while length(v_lista) > 1 DO
        ...
        if v_questionid is not null then
			...
			Insert into tb_questions (questionID, description, questionTypeID,listTypeID,questionGroupID,subordinateTo,subordinateValues,isAbout,`comment`) VALUES (v_questionid,v_answer,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
(613, 12, 'Admission Form', 2, '2022-11-01 03:03:30', '2022-11-01 03:03:30');
...
(1, 'Grávida?', 'Grávida?'),
(2, 'Grávida?', 'Grávida?'),
(1, 'Tempo de gravidez', 'Tempo de gravidez'),
(2, 'Tempo de gravidez', 'Tempo de gravidez'),
(1, 'Início de Sintomas (data do primeiro sintoma)', 'Início de Sintomas (data do primeiro sintoma)'),
(2, 'Início de Sintomas (data do primeiro sintoma)', 'Início de Sintomas (data do primeiro sintoma)'),
(1, 'Data de admissão nesta unidade', 'Data de admissão nesta unidade'),
(2, 'Data de admissão nesta unidade', 'Data de admissão nesta unidade'),
(1, 'Temperatura', 'Temperatura'),
(2, 'Temperatura', 'Temperatura'),
(1, 'Frequência cardíaca', 'Frequência cardíaca'),
(2, 'Frequência cardíaca', 'Frequência cardíaca'),
(1, 'Frequência respiratória', 'Frequência respiratória'),
(2, 'Frequência respiratória', 'Frequência respiratória'),
(1, 'Pressão arterial (sistólica)', 'Pressão arterial (sistólica)'),
(2, 'Pressão arterial (sistólica)', 'Pressão arterial (sistólica)'),
(1, 'Pressão arterial (diastólica)', 'Pressão arterial (diastólica)'),
(2, 'Pressão arterial (diastólica)', 'Pressão arterial (diastólica)'),
(1, 'Desidratação severa', 'Desidratação severa'),
(2, 'Desidratação severa', 'Desidratação severa'),
(1, 'Tempo de enchimento capilar >2 segundos', 'Tempo de enchimento capilar >2 segundos'),
(2, 'Tempo de enchimento capilar >2 segundos', 'Tempo de enchimento capilar >2 segundos'),
(1, 'Saturação de oxigênio', 'Saturação de oxigênio'),
(2, 'Saturação de oxigênio', 'Saturação de oxigênio'),
(1, 'em', 'em'),
(2, 'em', 'em'),
(1, 'Escala A V D I', 'Escala A V D I'),
(2, 'Escala A V D I', 'Escala A V D I'),
(1, 'Escala de Coma de Glasgow (GCS /15)', 'Escala de Coma de Glasgow (GCS /15)'),
(2, 'Escala de Coma de Glasgow (GCS /15)', 'Escala de Coma de Glasgow (GCS /15)'),
(1, 'Desnutrição', 'Desnutrição'),
(2, 'Desnutrição', 'Desnutrição'),
(1, 'Circunferência braquial', 'Circunferência braquial'),
(2, 'Circunferência braquial', 'Circunferência braquial'),
(1, 'Altura', 'Altura'),
(2, 'Altura', 'Altura'),
(1, 'Peso', 'Peso'),
(2, 'Peso', 'Peso'),
(1, 'Doença cardíaca crônica (não hipertensão)', 'Doença cardíaca crônica (não hipertensão)'),
(2, 'Doença cardíaca crônica (não hipertensão)', 'Doença cardíaca crônica (não hipertensão)'),
(1, 'Hipertensão', 'Hipertensão'),
(2, 'Hipertensão', 'Hipertensão'),
(1, 'Doença pulmonar crônica', 'Doença pulmonar crônica'),
(2, 'Doença pulmonar crônica', 'Doença pulmonar crônica'),
(1, 'Asma', 'Asma'),
(2, 'Asma', 'Asma'),
(1, 'Doença renal crônica', 'Doença renal crônica'),
(2, 'Doença renal crônica', 'Doença renal crônica'),
(1, 'Doença hepática crônica', 'Doença hepática crônica'),
(2, 'Doença hepática crônica', 'Doença hepática crônica'),
(1, 'Doença neurológica crônica', 'Doença neurológica crônica'),
(2, 'Doença neurológica crônica', 'Doença neurológica crônica'),
(1, 'HIV', 'HIV'),
(2, 'HIV', 'HIV'),
(1, 'Diabete', 'Diabete'),
(2, 'Diabete', 'Diabete'),
(1, 'Fumante', 'Fumante'),
(2, 'Fumante', 'Fumante'),
(1, 'Tuberculose', 'Tuberculose'),
(2, 'Tuberculose', 'Tuberculose'),
(1, 'Asplenia', 'Asplenia'),
(2, 'Asplenia', 'Asplenia'),
(1, 'Neoplasma maligno', 'Neoplasma maligno'),
(2, 'Neoplasma maligno', 'Neoplasma maligno'),
(1, 'Outras comorbidades', 'Outras comorbidades'),
(2, 'Outras comorbidades', 'Outras comorbidades'),
(1, 'Outras comorbidades', 'Outras comorbidades'),
(2, 'Outras comorbidades', 'Outras comorbidades'),
(1, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)'),
(2, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)'),
(1, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 'Bloqueadores dos receptores de angiotensina II (BRAs)'),
(2, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 'Bloqueadores dos receptores de angiotensina II (BRAs)'),
(1, 'Antiinflamatório não esteroide (AINE)', 'Antiinflamatório não esteroide (AINE)'),
(2, 'Antiinflamatório não esteroide (AINE)', 'Antiinflamatório não esteroide (AINE)'),
(1, 'Qual antiviral', 'Qual antiviral'),
(2, 'Qual antiviral', 'Qual antiviral'),
(1, 'Qual outro antiviral', 'Qual outro antiviral'),
(2, 'Qual outro antiviral', 'Qual outro antiviral'),
(1, 'Histórico de febre', 'Histórico de febre'),
(2, 'Histórico de febre', 'Histórico de febre'),
(1, 'Tosse', 'Tosse'),
(2, 'Tosse', 'Tosse'),
(1, 'Tosse com expectoração', 'Tosse com expectoração'),
(2, 'Tosse com expectoração', 'Tosse com expectoração'),
(1, 'Tosse com hemóptise', 'Tosse com hemóptise'),
(2, 'Tosse com hemóptise', 'Tosse com hemóptise'),
(1, 'Dor de garganta', 'Dor de garganta'),
(2, 'Dor de garganta', 'Dor de garganta'),
(1, 'Coriza (rinorréia)', 'Coriza (rinorréia)'),
(2, 'Coriza (rinorréia)', 'Coriza (rinorréia)'),
(1, 'Respiração sibilante', 'Respiração sibilante'),
(2, 'Respiração sibilante', 'Respiração sibilante'),
(1, 'Dor no peito', 'Dor no peito'),
(2, 'Dor no peito', 'Dor no peito'),
(1, 'Dor muscular (mialgia)', 'Dor muscular (mialgia)'),
(2, 'Dor muscular (mialgia)', 'Dor muscular (mialgia)'),
(1, 'Dor articular (artralgia)', 'Dor articular (artralgia)'),
(2, 'Dor articular (artralgia)', 'Dor articular (artralgia)'),
(1, 'Fadiga/mal estar', 'Fadiga/mal estar'),
(2, 'Fadiga/mal estar', 'Fadiga/mal estar'),
(1, 'Perda do paladar', 'Perda do paladar'),
(2, 'Perda do paladar', 'Perda do paladar'),
(1, 'Perda do Olfato', 'Perda do Olfato'),
(2, 'Perda do Olfato', 'Perda do Olfato'),
(1, 'Falta de ar', 'Falta de ar'),
(2, 'Falta de ar', 'Falta de ar'),
(1, 'Retração toráxica', 'Retração toráxica'),
(2, 'Retração toráxica', 'Retração toráxica'),
(1, 'Dor de cabeça', 'Dor de cabeça'),
(2, 'Dor de cabeça', 'Dor de cabeça'),
(1, 'Consciência alterada/confusão', 'Consciência alterada/confusão'),
(2, 'Consciência alterada/confusão', 'Consciência alterada/confusão'),
(1, 'Convulsões', 'Convulsões'),
(2, 'Convulsões', 'Convulsões'),
(1, 'Dor abdominal', 'Dor abdominal'),
(2, 'Dor abdominal', 'Dor abdominal'),
(1, 'Vômito/náusea', 'Vômito/náusea'),
(2, 'Vômito/náusea', 'Vômito/náusea'),
(1, 'Diarréia', 'Diarréia'),
(2, 'Diarréia', 'Diarréia'),
(1, 'Conjuntivite', 'Conjuntivite'),
(2, 'Conjuntivite', 'Conjuntivite'),
(1, 'Erupções cutâneas', 'Erupções cutâneas'),
(2, 'Erupções cutâneas', 'Erupções cutâneas'),
(1, 'Úlceras cutâneas', 'Úlceras cutâneas'),
(2, 'Úlceras cutâneas', 'Úlceras cutâneas'),
(1, 'Linfadenopatia', 'Linfadenopatia'),
(2, 'Linfadenopatia', 'Linfadenopatia'),
(1, 'Incapaz de andar', 'Incapaz de andar'),
(2, 'Incapaz de andar', 'Incapaz de andar'),
(1, 'Sangramento (hemorragia)', 'Sangramento (hemorragia)'),
(2, 'Sangramento (hemorragia)', 'Sangramento (hemorragia)'),
(1, 'Localidade', 'Localidade'),
(2, 'Localidade', 'Localidade'),
(1, 'Outros', 'Outros'),
(2, 'Outros', 'Outros'),
(1, 'Qual sinal ou sintoma', 'Qual sinal ou sintoma'),
(2, 'Qual sinal ou sintoma', 'Qual sinal ou sintoma'),
(1, 'Hidratação oral/orogástrica', 'Hidratação oral/orogástrica'),
(2, 'Hidratação oral/orogástrica', 'Hidratação oral/orogástrica'),
(1, 'Hidratação venosa', 'Hidratação venosa'),
(2, 'Hidratação venosa', 'Hidratação venosa'),
(1, 'Antiviral', 'Antiviral'),
(2, 'Antiviral', 'Antiviral'),
(1, 'Qual antiviral', 'Qual antiviral'),
(2, 'Qual antiviral', 'Qual antiviral'),
(1, 'Qual outro antiviral', 'Qual outro antiviral'),
(2, 'Qual outro antiviral', 'Qual outro antiviral'),
(1, 'Corticosteroide', 'Corticosteroide'),
(2, 'Corticosteroide', 'Corticosteroide'),
(1, 'Qual via do corticosteroide', 'Qual via do corticosteroide'),
(2, 'Qual via do corticosteroide', 'Qual via do corticosteroide'),
(1, 'Dose diária máxima de corticosteroide', 'Dose diária máxima de corticosteroide'),
(2, 'Dose diária máxima de corticosteroide', 'Dose diária máxima de corticosteroide'),
(1, 'Antibiótico', 'Antibiótico'),
(2, 'Antibiótico', 'Antibiótico'),
(1, 'Agente antifungal', 'Agente antifungal'),
(2, 'Agente antifungal', 'Agente antifungal'),
(1, 'Agente antimalárico', 'Agente antimalárico'),
(2, 'Agente antimalárico', 'Agente antimalárico'),
(1, 'Qual agente antimalárico', 'Qual agente antimalárico'),
(2, 'Qual agente antimalárico', 'Qual agente antimalárico'),
(1, 'Agente experimental', 'Agente experimental'),
(2, 'Agente experimental', 'Agente experimental'),
(1, 'Qual agente experimental', 'Qual agente experimental'),
(2, 'Qual agente experimental', 'Qual agente experimental'),
(1, 'Antiinflamatório não esteroide (AINE)', 'Antiinflamatório não esteroide (AINE)'),
(2, 'Antiinflamatório não esteroide (AINE)', 'Antiinflamatório não esteroide (AINE)'),
(1, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)'),
(2, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)'),
(1, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 'Bloqueadores dos receptores de angiotensina II (BRAs)'),
(2, 'Bloqueadores dos receptores de angiotensina II (BRAs)', 'Bloqueadores dos receptores de angiotensina II (BRAs)'),
(1, 'Anticoagulação sistêmica', 'Anticoagulação sistêmica'),
(2, 'Anticoagulação sistêmica', 'Anticoagulação sistêmica'),
(1, 'UTI ou UCE', 'UTI ou UCE'),
(2, 'UTI ou UCE', 'UTI ou UCE'),
(1, 'Oxigenoterapia', 'Oxigenoterapia'),
(2, 'Oxigenoterapia', 'Oxigenoterapia'),
(1, 'Vazão de O2', 'Vazão de O2'),
(2, 'Vazão de O2', 'Vazão de O2'),
(1, 'Fonte de Oxigênio', 'Fonte de Oxigênio'),
(2, 'Fonte de Oxigênio', 'Fonte de Oxigênio'),
(1, 'Interface de oxigenoterapia', 'Interface de oxigenoterapia'),
(2, 'Interface de oxigenoterapia', 'Interface de oxigenoterapia'),
(1, 'Ventilação não-invasiva', 'Ventilação não-invasiva'),
(2, 'Ventilação não-invasiva', 'Ventilação não-invasiva'),
(1, 'Posição prona', 'Posição prona'),
(2, 'Posição prona', 'Posição prona'),
(1, 'Ventilação invasiva', 'Ventilação invasiva'),
(2, 'Ventilação invasiva', 'Ventilação invasiva'),
(1, 'Pressão expiratória final positiva', 'Pressão expiratória final positiva'),
(2, 'Pressão expiratória final positiva', 'Pressão expiratória final positiva'),
(1, 'Fração de oxigênio inspirado', 'Fração de oxigênio inspirado'),
(2, 'Fração de oxigênio inspirado', 'Fração de oxigênio inspirado'),
(1, 'Pressão do plato', 'Pressão do plato'),
(2, 'Pressão do plato', 'Pressão do plato'),
(1, 'Pressão parcial do CO2', 'Pressão parcial do CO2'),
(2, 'Pressão parcial do CO2', 'Pressão parcial do CO2'),
(1, 'Pressão parcial do O2', 'Pressão parcial do O2'),
(2, 'Pressão parcial do O2', 'Pressão parcial do O2'),
(1, 'Inotrópicos/vasopressores', 'Inotrópicos/vasopressores'),
(2, 'Inotrópicos/vasopressores', 'Inotrópicos/vasopressores'),
(1, 'Suporte extracorpóreo (ECMO)', 'Suporte extracorpóreo (ECMO)'),
(2, 'Suporte extracorpóreo (ECMO)', 'Suporte extracorpóreo (ECMO)'),
(1, 'Terapia de substituição renal ou diálise', 'Terapia de substituição renal ou diálise'),
(2, 'Terapia de substituição renal ou diálise', 'Terapia de substituição renal ou diálise'),
(1, 'Hemoglobina', 'Hemoglobina'),
(2, 'Hemoglobina', 'Hemoglobina'),
(1, 'Leucócitos', 'Leucócitos'),
(2, 'Leucócitos', 'Leucócitos'),
(1, 'Hematócrito', 'Hematócrito'),
(2, 'Hematócrito', 'Hematócrito'),
(1, 'Plaquetas', 'Plaquetas'),
(2, 'Plaquetas', 'Plaquetas'),
(1, 'TTPA/APTR', 'TTPA/APTR'),
(2, 'TTPA/APTR', 'TTPA/APTR'),
(1, 'TP', 'TP'),
(2, 'TP', 'TP'),
(1, 'INR', 'INR'),
(2, 'INR', 'INR'),
(1, 'ALT/TGP', 'ALT/TGP'),
(2, 'ALT/TGP', 'ALT/TGP'),
(1, 'Bilirrubina total', 'Bilirrubina total'),
(2, 'Bilirrubina total', 'Bilirrubina total'),
(1, 'AST/TGO', 'AST/TGO'),
(2, 'AST/TGO', 'AST/TGO'),
(1, 'Uréia (BUN)', 'Uréia (BUN)'),
(2, 'Uréia (BUN)', 'Uréia (BUN)'),
(1, 'Lactose', 'Lactose'),
(2, 'Lactose', 'Lactose'),
(1, 'Creatinina', 'Creatinina'),
(2, 'Creatinina', 'Creatinina'),
(1, 'Sódio', 'Sódio'),
(2, 'Sódio', 'Sódio'),
(1, 'Procalcitonina', 'Procalcitonina'),
(2, 'Procalcitonina', 'Procalcitonina'),
(1, 'Potássio', 'Potássio'),
(2, 'Potássio', 'Potássio'),
(1, 'PCR', 'PCR'),
(2, 'PCR', 'PCR'),
(1, 'LDH', 'LDH'),
(2, 'LDH', 'LDH'),
(1, 'Creatina quinase', 'Creatina quinase'),
(2, 'Creatina quinase', 'Creatina quinase'),
(1, 'Troponina', 'Troponina'),
(2, 'Troponina', 'Troponina'),
(1, 'VHS', 'VHS'),
(2, 'VHS', 'VHS'),
(1, 'Dimero D', 'Dimero D'),
(2, 'Dimero D', 'Dimero D'),
(1, 'Ferritina', 'Ferritina'),
(2, 'Ferritina', 'Ferritina'),
(1, 'IL-6]', 'IL-6]'),
(2, 'IL-6]', 'IL-6]');
...
(379, 'Critérios Clínicos para Inclusão', ''),
(380, 'Dados demográficos', ''),
(381, 'Início da doença e sinais vitais na admissão', ''),
(382, 'Comorbidades', ''),
(383, 'Pré-admissão e medicamentos de uso contínuo', ''),
(384, 'Sinais e sintomas na hora da admissão', ''),
(385, 'Medicação', ''),
(386, 'Cuidados', ''),
(387, 'Resultados laboratoriais]', ''),
(388, 'Critérios Clínicos para Inclusão', ''),
(389, 'Dados demográficos', ''),
(390, 'Início da doença e sinais vitais na admissão', ''),
(391, 'Comorbidades', ''),
(392, 'Pré-admissão e medicamentos de uso contínuo', ''),
(393, 'Sinais e sintomas na hora da admissão', ''),
(394, 'Medicação', ''),
(395, 'Cuidados', ''),
(396, 'Resultados laboratoriais]', ''),
(397, 'Critérios Clínicos para Inclusão', ''),
(398, 'Dados demográficos', ''),
(399, 'Início da doença e sinais vitais na admissão', ''),
(400, 'Comorbidades', ''),
(401, 'Pré-admissão e medicamentos de uso contínuo', ''),
(402, 'Sinais e sintomas na hora da admissão', ''),
(403, 'Medicação', ''),
(404, 'Cuidados', ''),
(405, 'Resultados laboratoriais]', ''),
(406, 'Critérios Clínicos para Inclusão', ''),
(407, 'Dados demográficos', ''),
(408, 'Início da doença e sinais vitais na admissão', ''),
(409, 'Comorbidades', ''),
(410, 'Pré-admissão e medicamentos de uso contínuo', ''),
(411, 'Sinais e sintomas na hora da admissão', ''),
(412, 'Medicação', ''),
(413, 'Cuidados', ''),
(414, 'Resultados laboratoriais]', ''),
(415, 'Critérios Clínicos para Inclusão', ''),
(416, 'Dados demográficos', ''),
(417, 'Início da doença e sinais vitais na admissão', ''),
(418, 'Comorbidades', ''),
(419, 'Pré-admissão e medicamentos de uso contínuo', ''),
(420, 'Sinais e sintomas na hora da admissão', ''),
(421, 'Medicação', ''),
(422, 'Cuidados', ''),
(423, 'Resultados laboratoriais]', ''),
(424, 'Critérios Clínicos para Inclusão', ''),
(425, 'Dados demográficos', ''),
(426, 'Início da doença e sinais vitais na admissão', ''),
(427, 'Comorbidades', ''),
(428, 'Pré-admissão e medicamentos de uso contínuo', ''),
(429, 'Sinais e sintomas na hora da admissão', ''),
(430, 'Medicação', ''),
(431, 'Cuidados', ''),
(432, 'Resultados laboratoriais]', '');
...
(12, 'TesteSalvamento', 2, 1, 0, '0.0', '2022-11-01 00:17:16', '2022-11-01 00:17:16');
...
CREATE TABLE `tb_questions` (
  `questionID` int(10) NOT NULL,
  `description` varchar(255) NOT NULL COMMENT '(pt-br) Descrição.\r\n(en) description.',
  `questionTypeID` int(10) DEFAULT NULL COMMENT '(pt-br) Chave estrangeira para tabela tb_QuestionsTypes.\r\n(en) Foreign key for the tp_QuestionsTypes table.',
  `listTypeID` int(10) DEFAULT NULL,
...
(258, 'País', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(259, 'País', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(260, 'Nome da Instalação', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(261, 'Data de inscrição', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(262, 'Quadro de infecção comprovada ou suspeita com patógeno de interesse para a Saúde Pública', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(263, 'Um histórico de febre autorelatado ou febre medida de ≥ 38oC', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(264, 'Tosse', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(265, 'Dispneia (falta de ar) ou Taquipneia', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(266, 'Suspeita clínica de IRA apesar de não apresentar os sintomas acima', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(267, 'Sexo ao Nascer', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(268, 'Data de nascimento', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(269, 'Idade (meses)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(270, 'Idade (anos)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(271, 'Profissional de Saúde', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(272, 'Profissional de Laboratório', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(273, 'Grávida?', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(274, 'Tempo de gravidez', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(275, 'Início de Sintomas (data do primeiro sintoma)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(276, 'Data de admissão nesta unidade', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(277, 'Temperatura', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(278, 'Frequência cardíaca', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(279, 'Frequência respiratória', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(280, 'Pressão arterial (sistólica)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(281, 'Pressão arterial (diastólica)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(282, 'Desidratação severa', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(283, 'Tempo de enchimento capilar >2 segundos', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(284, 'Saturação de oxigênio', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(285, 'em', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(286, 'Escala A V D I', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(287, 'Escala de Coma de Glasgow (GCS /15)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(288, 'Desnutrição', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(289, 'Circunferência braquial', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(290, 'Altura', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(291, 'Peso', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(292, 'Doença cardíaca crônica (não hipertensão)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(293, 'Hipertensão', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(294, 'Doença pulmonar crônica', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(295, 'Asma', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(296, 'Doença renal crônica', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(297, 'Doença hepática crônica', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(298, 'Doença neurológica crônica', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(299, 'HIV', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(300, 'Diabete', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(301, 'Fumante', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(302, 'Tuberculose', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(303, 'Asplenia', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(304, 'Neoplasma maligno', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(305, 'Outras comorbidades', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(306, 'Outras comorbidades', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(307, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(308, 'Bloqueadores dos receptores de angiotensina II (BRAs)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(309, 'Antiinflamatório não esteroide (AINE)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(310, 'Qual antiviral', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(311, 'Qual outro antiviral', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(312, 'Histórico de febre', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(313, 'Tosse', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(314, 'Tosse com expectoração', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(315, 'Tosse com hemóptise', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(316, 'Dor de garganta', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(317, 'Coriza (rinorréia)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(318, 'Respiração sibilante', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(319, 'Dor no peito', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(320, 'Dor muscular (mialgia)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(321, 'Dor articular (artralgia)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(322, 'Fadiga/mal estar', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(323, 'Perda do paladar', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(324, 'Perda do Olfato', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(325, 'Falta de ar', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(326, 'Retração toráxica', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(327, 'Dor de cabeça', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(328, 'Consciência alterada/confusão', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(329, 'Convulsões', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(330, 'Dor abdominal', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(331, 'Vômito/náusea', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(332, 'Diarréia', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(333, 'Conjuntivite', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(334, 'Erupções cutâneas', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(335, 'Úlceras cutâneas', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(336, 'Linfadenopatia', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(337, 'Incapaz de andar', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(338, 'Sangramento (hemorragia)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(339, 'Localidade', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(340, 'Outros', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(341, 'Qual sinal ou sintoma', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(342, 'Hidratação oral/orogástrica', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(343, 'Hidratação venosa', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(344, 'Antiviral', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(345, 'Qual antiviral', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(346, 'Qual outro antiviral', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(347, 'Corticosteroide', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(348, 'Qual via do corticosteroide', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(349, 'Dose diária máxima de corticosteroide', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(350, 'Antibiótico', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(351, 'Agente antifungal', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(352, 'Agente antimalárico', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(353, 'Qual agente antimalárico', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(354, 'Agente experimental', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(355, 'Qual agente experimental', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(356, 'Antiinflamatório não esteroide (AINE)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(357, 'Inibidores da enzima de conversão da angiotensina (inibidores da ECA)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(358, 'Bloqueadores dos receptores de angiotensina II (BRAs)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(359, 'Anticoagulação sistêmica', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(360, 'UTI ou UCE', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(361, 'Oxigenoterapia', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(362, 'Vazão de O2', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(363, 'Fonte de Oxigênio', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(364, 'Interface de oxigenoterapia', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(365, 'Ventilação não-invasiva', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(366, 'Posição prona', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(367, 'Ventilação invasiva', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(368, 'Pressão expiratória final positiva', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(369, 'Fração de oxigênio inspirado', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(370, 'Pressão do plato', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(371, 'Pressão parcial do CO2', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(372, 'Pressão parcial do O2', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(373, 'Inotrópicos/vasopressores', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(374, 'Suporte extracorpóreo (ECMO)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(375, 'Terapia de substituição renal ou diálise', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(376, 'Hemoglobina', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(377, 'Leucócitos', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(378, 'Hematócrito', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(379, 'Plaquetas', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(380, 'TTPA/APTR', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(381, 'TP', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(382, 'INR', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(383, 'ALT/TGP', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(384, 'Bilirrubina total', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(385, 'AST/TGO', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(386, 'Uréia (BUN)', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(387, 'Lactose', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(388, 'Creatinina', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(389, 'Sódio', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(390, 'Procalcitonina', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(391, 'Potássio', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(392, 'PCR', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(393, 'LDH', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(394, 'Creatina quinase', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(395, 'Troponina', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(396, 'VHS', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(397, 'Dimero D', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(398, 'Ferritina', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(399, 'IL-6]', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `tb_crfforms`
  MODIFY `crfFormsID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=614;
...
--
ALTER TABLE `tb_questiongroup`
  MODIFY `questionGroupID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=433;
...
--
ALTER TABLE `tb_questions`
  MODIFY `questionID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=400;
